...
function _extractEntityId(payload: any, item: { entityType: string; operationUuid: string }): string { return String(payload.id || payload.entity_id || payload.remark_id || payload.diary_id || payload.unitId || item.operationUuid) }