...
export function SpeedEntryGrid({ project, orgId, onRefresh }: Props) {
  ...
  return <div className="space-y-3" dir="rtl">
    <Alert><AlertTriangle className="h-4 w-4"/><AlertDescription>{appliedPairCount === 0 ? 'لا توجد بنود مطبقة على الوحدات الحالية. طبّق بنود Master BOQ من إعداد المشروع قبل الإدخال؛ لن يتم إنشاء حقل إدخال لبند غير مطبق.' : 'بنود المشروع معرفة مرة واحدة في BOQ. القيم في الجدول هي حالة تنفيذ البند لكل وحدة، وليست بنوداً مكررة.'}</AlertDescription></Alert>
