...
- ProjectUnit: Physical unit within a project
- BOQItem: Dynamic Bill of Quantities line item per unit
- ProjectDictionary: Project/org-configurable vocabulary; never hard-code domain labels in UI
"""
...
class Project(Base):
    ...
    __table_args__ = (UniqueConstraint("org_id", "code", name="uq_projects_org_code"), Index("ix_projects_org_id", "org_id"), Index("ix_projects_status", "status"))
...
class ProjectUnit(Base):
    ...
    __table_args__ = (UniqueConstraint("project_id", "code", name="uq_units_project_code"), Index("ix_project_units_org_id", "org_id"), Index("ix_project_units_project_id", "project_id"))
...
class BOQItem(Base):
    ...
    __table_args__ = (Index("ix_boq_items_org_id", "org_id"), Index("ix_boq_items_unit_id", "unit_id"))
